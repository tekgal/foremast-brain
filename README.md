# Foremast Brain
[![Build Status](https://travis-ci.org/tekgal/foremast-brain.svg?branch=master)](https://travis-ci.org/tekgal/foremast-brain)[![Slack Chat](https://img.shields.io/badge/slack-live-orange.svg)](https://foremastio.slack.com/)
